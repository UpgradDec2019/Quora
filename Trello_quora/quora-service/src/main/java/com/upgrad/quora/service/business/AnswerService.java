...
public class AnswerService {
	 ...
	 * @return
	 * @throws AnswerNotFoundException      ANS-001 if the answer is not found in
	 *                                      the database.
	 * @throws AuthorizationFailedException ATHR-001 If the user has not signed in
	 *                                      and ATHR-002 If the * user is already
	 *                                      signed out and ATHR-003 if the user is
	 *                                      not the owner of the answer.
	 */
	@Transactional(propagation = Propagation.REQUIRED)
	 ...
	 *                                      ATHR-003 if non admin or non owner of
	 *                                      the answer tries to delete the answer.
	 ...
	 * @throws AuthorizationFailedException ATHR-001 - if User has not signed in.
	 *                                      ATHR-002 if the User is signed out.
	 * @throws InvalidQuestionException     The question with entered uuid whose
	 *                                      details are to be seen does not exist.
	 */
